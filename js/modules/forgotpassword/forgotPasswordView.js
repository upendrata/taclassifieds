classified.forgotPwdView = Backbone.View.extend({
	...
	renderSecurityQues:function(){
		var questionsListObj = new classified.securityQuesListView({el:".security-ques",template:"#ta-classifieds-security-questions-tpl",model:this.model});
	},
	events :{
	...
	showContinueButton:function(){
		if($(".security-ques option:selected").length!=null && $(".security-ans").val().length>=2){
